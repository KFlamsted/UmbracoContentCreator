...
import { fetchNewsPage, fetchNewsItemPage, fetchBlueskyPage, fetchStreamingPage } from '../services/PageLoaderService'
...
export const useStreamingPage = () => useContent<StreamingPage>(fetchStreamingPage)
