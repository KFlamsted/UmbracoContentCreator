...
export const PositionedComponent: React.FC<PositionedComponentProps> = ({
  ...
  return (
    <div id={id} className={`${positionClasses} ${className}`}>
      {children}
    </div>
  )
}
...
export const AbsoluteTopRightComponent: React.FC<{
  ...
  return (
    <div id={id} className={`absolute ${getSpacingClasses()} ${className}`}>
      {children}
    </div>
  )
}
...
export const CenteredPositionedComponent: React.FC<
  CenteredPositionedComponentProps
> = ({
  id,
  children,
  position = 'fixed',
